...
// 8207876608/8217876608
MongoClient.connect('mongodb://localhost:27017/RedbusShuttle', (error, db) => {
  if(error){
    console.log(error);
  ...
  // db.collection('BoardingPoint').insertOne({
  //     bpId: 1,
  //     bpName: "Madiwala",
  //     isActive: true
  // }, (error, result) => {
  //     if(error, result){
  //         return console.log("Unable to insert boarding point", err);
  //     }
  ...
  //   });
    ...
    // }, (error, result) => {
    //     if(error){
    //         return console.log("Unable to insert route")
    //     }
    //     console.log(JSON.stringify(result.ops));
    // })
    //
